...
public class EmployeeController {
	...
	/*
	 * @RequestMapping("/checkLogin1.do") public String checkLogin1(HttpSession
	 * session, Employee employee){ Employee employee2 =
	 * employeeService.checkLogin(employee.getEmployeeNumber(),
	 * employee.getPassword()); if (employee2 != null) {
	 * session.setAttribute("loged", employee2); String level =
	 * employee2.getPosition().getLevel(); if (level.equals("人事部主任")) { return
	 * "admin/index1"; }else if (level.equals("人事部员工")) { return "admin/index2";
	 * }else if (level.equals("部门主任")) { return "admin/index3"; }else { return
	 * "admin/index4"; } }else{ return "login"; } }
	 */
	...
	/*
	 * @RequestMapping("/logout1.do") public String logout1(HttpSession session){
	 * session.removeAttribute("loged"); return "login"; }
	 */
